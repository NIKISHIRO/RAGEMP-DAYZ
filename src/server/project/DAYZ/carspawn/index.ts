...
mp.events.addCommand('pos',(p:PlayerMp) => {
    console.log(p.position)
    Car.saveCar("g65amg", new mp.Vector3(111,111,111), new mp.Vector3(0,0,111), [255,255,255,0,0,0], 'spawn tachka');
})

mp.events.addCommand('sc', (p:PlayerMp,ft:string,hash:string, rotation, color:string, description:string)=>{
    console.log('VEH'+vehicleCoords)
